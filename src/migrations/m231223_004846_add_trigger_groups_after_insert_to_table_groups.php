    ...
    public function safeUp()
    {
        ...
        $sql = <<< SQL
            CREATE DEFINER=`$db_user`@`%` TRIGGER `groups_after_insert` after INSERT ON `groups` FOR EACH ROW BEGIN
                ...
                INSERT INTO `rules` (`user_id`, `group_id`, `controller`, `actions`, `origin`,`path`, `status`) VALUES (NULL,NEW.id,  'user', 'profile;edit;change-lang;change-theme', '*','weebz/controllers', 1);
