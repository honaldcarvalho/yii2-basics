...
class UploadFoto extends \yii\bootstrap5\Widget
{
  ...
  {
      \Yii::$app->view->registerJsFile(\app\controllers\Controller::$assetsDir . '/plugins/cropper/cropper.min.js');
      \Yii::$app->view->registerCssFile(\app\controllers\Controller::$assetsDir . '/plugins/cropper/cropper.min.css');
  }
