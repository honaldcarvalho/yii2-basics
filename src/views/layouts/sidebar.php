...
if(!empty($params->file_id)){
    ...
    $login_image = "<img src='/images/logo_weebz.png' alt='{$params->title}' class='brand-image img-circle elevation-3' style='opacity: .8'>";
}

?>
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?=Yii::getAlias('@rootUrl/');?>" class="brand-link">
        <?= $login_image ?>
